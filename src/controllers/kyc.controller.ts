...
export async function uploadKYCDocument(req: Request, res: Response) {
    ...
    if (!documentType) {
        return res
            .status(400)
            .json({ status: "fail", message: "Document Type Required" });
    }
    ...
    try {
        documentURL = await uploadToFirebase(
            `kyc-documents/${userId}/${document.originalname}`,
            document,
        );
    } catch (error) {
        return res
            .status(400)
            .json({ status: "fail", message: "Failed To Upload KYC Document" });
    }
    ...
    try {
        ...
        return res
            .status(200)
            .json({ status: "success", message: "KYC Document Uploaded" });
    } catch (error) {
...
export async function listPendingKYCRequests(req: Request, res: Response) {
    ...
    try {
        ...
        return res
            .status(400)
            .json({ status: "fail", message: "Failed To Get KYC Requests" });
    }
}
...
export async function approveKYCRequest(req: Request, res: Response) {
    ...
    try {
        ...
        return res
            .status(200)
            .json({ status: "success", message: "KYC Request Approved" });
    } catch (error) {
        console.log(`error: ${error}`);
        return res
            .status(400)
            .json({ status: "fail", message: "Failed To Approve KYC Request" });
    }
}
...
export async function rejectKYCRequest(req: Request, res: Response) {
    ...
    try {
        ...
        return res
            .status(200)
            .json({ status: "success", message: "KYC Request Rejected" });
    } catch (error) {
        console.log(`error: ${error}`);
        return res
            .status(400)
            .json({ status: "fail", message: "Failed To Reject KYC Request" });
    }
}
...
export async function getKYCStatus(req: Request, res: Response) {
    ...
    try {
        ...
        return res
            .status(400)
            .json({ status: "fail", message: "Failed To Get KYC Status" });
    }
}
